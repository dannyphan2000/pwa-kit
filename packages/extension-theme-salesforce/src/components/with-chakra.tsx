...
type WithChakra = React.ComponentPropsWithoutRef<any>
 ...
 */
export const withChakra = <P extends object>(
    WrappedComponent: React.ComponentType<P>,
    theme?: Theme
) => {
    const WithChakra: React.FC<P> = (props: WithChakra) => {
        ...
        // is always the first.
        const mergedTheme: any = extendTheme(...extensions.reverse().map((extension: any) => {
