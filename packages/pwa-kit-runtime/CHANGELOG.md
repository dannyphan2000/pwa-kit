...
- Remove forced garbage collection on each invocation. Set `FORCE_GC=true` for the old behavior. [#2251](https://github.com/SalesforceCommerceCloud/pwa-kit/pull/2251)
