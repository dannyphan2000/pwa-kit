...
class ChakraProductDetailExtension extends ApplicationExtension<Config> {
    ...
    extendApp(app: Application): Application {
        app.get('/sample', (req, res) => {
            console.log('ChakraProductDetailExtension extendApp GET /sample')
            res.send(
...
export default ChakraProductDetailExtension
